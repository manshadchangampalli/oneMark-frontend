...
import { MASTERY, ACHIEVEMENTS, LEADERBOARD, buildHeatmap } from '@/constants';
          ...
          <Card>
            <div className="flex items-center justify-between mb-3">
              <div>
                ...
                <div className="text-[14px] font-medium text-ink dark:text-ink-dark mt-0.5">Last 13 weeks</div>
              </div>
              <div className="text-[11.5px] font-mono text-ink-muted dark:text-ink-muted-dark tab-num">
                <span className="text-ink dark:text-ink-dark">412</span> days
              </div>
            </div>
...
function HeatCell({ lvl }: { lvl: number }) {
  return (
    <div className="w-[14px] h-[14px] rounded-[3px] border border-black/4 dark:border-white/4 relative overflow-hidden">
